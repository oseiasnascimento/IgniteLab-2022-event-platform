...
const CREATE_SUBSCRIBE_MUTATION = gql`
  mutation CreateSbuscriber($name: String!, $email: String!) {
...
export function Subscribe() {
  ...
  async function handleSubscribed(event: FormEvent) {
  ...
  return (
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      ...
      <img src="/src/assets/code-mockup.png" className="mt-1" alt="" />
      <Footer />
    </div>
  )
}
